...
SESSIONS = ["session1.session", "session3.session", "session4.session", "session5.session", 
            "session6.session", "session7.session", "session8.session", "session9.session", "session2.session"]
...
BREAK_PROBABILITY = 0.1  # 10% chance of taking a longer break
...
if __name__ == "__main__":
    ...
    # Ensure asyncio runs correctly without blocking Flask
